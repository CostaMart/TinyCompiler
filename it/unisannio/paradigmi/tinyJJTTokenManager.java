/* tinyJJTTokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. tinyJJTTokenManager.java */
package it.unisannio.paradigmi;

/** Token Manager. */
public class tinyJJTTokenManager implements tinyJJTConstants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public tinyJJTTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public tinyJJTTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
