/* tinyJJT.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. tinyJJT.java */
package it.unisannio.paradigmi;

public class tinyJJT/*@bgen(jjtree)*/implements tinyJJTTreeConstants, tinyJJTConstants {/*@bgen(jjtree)*/
  protected static JJTtinyJJTState jjtree = new JJTtinyJJTState();public static void main(String args [])
  {
    System.out.println("Reading from standard input...");
    System.out.print("Enter an expression like \"1+(2+3)*var;\" :");
    new tinyJJT(System.in);
    try
    {
      SimpleNode n = tinyJJT.Start();
      n.dump("");
...
if (jjtc000) {
  ...
  static public tinyJJTTokenManager token_source;
  ...
  public tinyJJT(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public tinyJJT(java.io.InputStream stream, String encoding) {
	 ...
	 token_source = new tinyJJTTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public tinyJJT(java.io.Reader stream) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
 ...
 token_source = new tinyJJTTokenManager(jj_input_stream);
  ...
  public tinyJJT(tinyJJTTokenManager tm) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(tinyJJTTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jjtree.reset();
